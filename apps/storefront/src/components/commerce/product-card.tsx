                                ...
                                if (priceValue === 0) {
                                    return (
                                        <div className="flex flex-col items-start gap-0.5">
                                            <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-emerald-500 shrink-0" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <span className="text-[11px] font-extrabold text-emerald-600 leading-tight uppercase tracking-tight">Fiyat Sorunuz</span>
                                        </div>
                                    );
                                }
